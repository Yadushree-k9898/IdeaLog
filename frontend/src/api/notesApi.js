...
const API_URL = import.meta.env.VITE_API_URL + "/api/note";
...
export const getNotes = async (token) => {
  try {
    const response = await axios.get(`${API_URL}/api/note`, getHeaders(token));
    return response.data;
  } catch (error) {
    console.error("Error fetching notes:", error.response?.data || error.message);
    throw error;
...
export const getNoteById = async (token, noteId) => {
  try {
    const response = await axios.get(`${API_URL}/api/note/${noteId}`, getHeaders(token));
    return response.data;
  } catch (error) {
    console.error(`Error fetching note ${noteId}:`, error.response?.data || error.message);
    throw error;
...
export const createNote = async (token, noteData) => {
  try {
    const response = await axios.post(`${API_URL}/api/note`, noteData, getHeaders(token, true));
    return response.data;
  } catch (error) {
    console.error("Error creating note:", error.response?.data || error.message);
    throw error;
...
export const updateNote = async (token, noteId, updatedData) => {
  try {
    const response = await axios.put(`${API_URL}/api/note/${noteId}`, updatedData, getHeaders(token));
    return response.data;
  } catch (error) {
    console.error(`Error updating note ${noteId}:`, error.response?.data || error.message);
    throw error;
...
export const deleteNote = async (token, noteId) => {
  try {
    const response = await axios.delete(`${API_URL}/api/note/${noteId}`, getHeaders(token));
    return response.data;
  } catch (error) {
    console.error(`Error deleting note ${noteId}:`, error.response?.data || error.message);
    throw error;
...
export const searchNotes = async (token, keyword) => {
  try {
    const response = await axios.get(`${API_URL}/api/note/search?keyword=${encodeURIComponent(keyword)}`, getHeaders(token));
    return response.data;
  } catch (error) {
    console.error("Error searching notes:", error.response?.data || error.message);
    throw error;
